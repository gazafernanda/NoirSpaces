    ...
    >
      ...
      <main className="min-h-screen pt-32 px-12 pb-24 relative z-20">
        ...
        >
          ...
          <h1 className="font-['Playfair_Display'] text-4xl lg:text-5xl leading-tight mb-6">
        ...
        {/* Grid */}
        <div
          className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[1200px] mx-auto transition-all duration-800 delay-200 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
          {collections.map((item, index) => (
            <article
              key={item.id}
              className="bg-[rgba(255,255,255,0.02)] rounded-2xl overflow-hidden cursor-pointer transition-all duration-500 border border-[rgba(255,255,255,0.08)] animate-fade-in"
